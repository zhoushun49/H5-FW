...
SpSlidemenu.prototype.slideClose = function(callback) {
    var _this = this;
    ...
    //slideMenu close callback
    if(USM.isFunction(callback)){
        setTimeout(callback, ANIME_SPEED.slider + EVENT_MOE_TIME);
    }
};
...
SpSlidemenu.prototype.scrollTouchStart = function(event) {
    ...
    _this.slidemenuContent.removeEventListener(eventType, blockEvent, true);
...
SpSlidemenu.prototype.scrollTouchMove = function(event) {
    ...
    if (_this.scrollMoveReady) {
        ...
        if (deltaX > 5 || deltaY > 5) {
            ...
            var eventType = USM.getEventType();
            _this.slidemenuContent.addEventListener(eventType, blockEvent, true);
        }
    }
